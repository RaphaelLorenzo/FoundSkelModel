...
parser.add_argument('--semi', default=1.0, type=float, 
                    help='semi-supervised setting')
...
def main_worker(args):
    ...
    if args.finetune_dataset == 'pku_v2' and args.protocol == 'cross_subject':
        ...
        opts = options.opts_ntu_60_cross_view(observe_ratio=args.observe_ratio, semi=args.semi)
    elif args.finetune_dataset== 'ntu60' and args.protocol == 'cross_subject':
        opts = options.opts_ntu_60_cross_subject(observe_ratio=args.observe_ratio, semi=args.semi)
    elif args.finetune_dataset== 'ntu120' and args.protocol == 'cross_setup':
        opts = options.opts_ntu_120_cross_setup(observe_ratio=args.observe_ratio, semi=args.semi)
    elif args.finetune_dataset== 'ntu120' and args.protocol == 'cross_subject':
        opts = options.opts_ntu_120_cross_subject(observe_ratio=args.observe_ratio, semi=args.semi)
